...
public class ConvertVideo {
	...
	public ConvertVideo(String inputPath,String outputPath,String ffmpegPath,String videoname) {
		ConvertVideo.inputPath = inputPath;
		ConvertVideo.outputPath = outputPath;
		ConvertVideo.ffmpegPath = ffmpegPath;
		ConvertVideo.videoname=videoname;
	}
	...
	private static String processAVI(int type) {
		...
		commend.add("mp4");
		commend.add("-o");
		commend.add(outputPath +videoname+".AVI");
		try {
			...
			process.waitFor();
			return outputPath +videoname+".AVI";
		} catch (Exception e) {
			e.printStackTrace();
			return null;
		}
	...
	private static boolean processFlv(String oldfilepath) {
		...
		command.add("-s");
		command.add("600x500");
		command.add(outputPath +videoname+".flv");
		try {
